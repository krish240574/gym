...
li:"j"$;
i.l:();
i.IA:li h2i["0x43b0d7e5"];
i.MA:li h2i["0x931e8875"];
/i.XS = np.dtype(np.uint32).itemsize * 8 // 2
i.XS:16 ;
ifi:{[n]$[n>0;[i.l::i.l,li b2i (i2b li n)&((i2b h2i["0xffffffff"])); ifi[b2i prev/[32;i2b li n]]];:i.l]}
i.c2u32:{
 i.l:();
 $[(0h=type x) & (7h=at raze x)|(6h=at raze x);:x;];
 $[(7h=at x)|(6h=at x);[i.l:();ifi each x;:i.l];];
 $[10h=at x; 
   $["0x" in  enlist x 0 1;
      :h2i[x];
...
i.init:{[e;pe;skey;psz]
 ...
 :getae[];};
/ i.mixe[getae[]];};
ra:{[l]$[1<count l;[t:i2b each l;:li b2i t[0]|next/[32;t[1]]];:li l]}
hash:{[v]hc:i.IA;ma:i.MA;v:b2i (i2b v)|(i2b hc);hc*:ma;v*:hc;v:b2i (i2b v)|prev/[i.XS;i2b v];:v}
i.mixe:{[ae]}
