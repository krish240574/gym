...
ex_num:{[seed]MT[0]::seed;$[index>=n;[twst each til n;index::0];];y:i2b MT[index];y:y<>(i2b h2i[d])&prev/[u;y];y:y<>(i2b h2i[b])&next/[s;y];y:y<>(i2b h2i[c])&prev/[t;y];y:y<>next y;index+::1;:y&(i2b h2i["0xffffffff"])}
